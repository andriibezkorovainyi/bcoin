...
class Pool extends EventEmitter {
  ...
  resetCFHeadersChain() {
    ...
    this.cfHeaderChain.push(new CFHeaderEntry(consensus.ZERO_HASH, null, 0));
  }
...
class CFHeaderEntry {
  ...
  constructor(blockHash, header, height) {
